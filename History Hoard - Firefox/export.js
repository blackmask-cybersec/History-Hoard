    ...
    openRequest.onsuccess = function() {
        ...
        cursorReq.onsuccess = function() {
            ...
            if (cursor) {
                ...
                browser.downloads.download({url: exportURL, saveAs: true, filename: "History-Hoard.txt"})
            }
        }
    }
}
    ...
    openRequest.onsuccess = function() {
        ...
        cursorReq.onsuccess = function() {
            ...
            if (cursor) {
                ...
                let exportURL = URL.createObjectURL(blob)
                browser.downloads.download({url: exportURL, saveAs: true, filename: "History-Hoard.json"})
            }
        }
    }
}
